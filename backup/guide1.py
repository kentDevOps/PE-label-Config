...
"}")
        ...
        sizePolicy3.setHeightForWidth(self.fPrint.sizePolicy().hasHeightForWidth())
        self.fPrint.setSizePolicy(sizePolicy3)
...
"")
        ...
        self.mulPage.setCurrentIndex(2)
