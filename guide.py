...
"}")
        ...
        self.lbHeader.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"")
        ...
        self.lb_view_caption.setFont(font1)
...
" background-color: #26364d;\n"
"}")
        self.f_view_find.setFrameShape(QFrame.Shape.StyledPanel)
        self.f_view_find.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.tx_view_skuSearch.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.cb_view_product.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        ...
        self.cb_view_project.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.cb_view_project.setMouseTracking(True)
        ...
        self.cb_view_region.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.cb_view_region.setMouseTracking(True)
        ...
        sizePolicy1.setHeightForWidth(self.fKey.sizePolicy().hasHeightForWidth())
        self.fKey.setSizePolicy(sizePolicy1)
...
"}\n"
"\n"
"#fKey QPushButton:hover {\n"
"    background-color: #3a5a80; /* \u0110\u1ed5i m\u00e0u khi hover */\n"
"}\n"
"#fKey QPushButton:pressed {\n"
"    background-color: #3a5a80;   /* M\u00e0u khi b\u1ea5m */\n"
"    padding-left: 12px;           /* Gi\u1ea3m padding \u0111\u1ec3 c\u1ea3m gi\u00e1c nh\u1ecf l\u1ea1i */\n"
"    padding-top: 8px;\n"
"    transform: scale(0.95);       /* (Kh\u00f4ng h"
                        "\u1ed7 tr\u1ee3 trong Qt CSS, ch\u1ec9 c\u00f3 th\u1ec3 d\u00f9ng animation) */\n"
"}")
        self.fKey.setFrameShape(QFrame.Shape.StyledPanel)
        self.fKey.setFrameShadow(QFrame.Shadow.Raised)
...
"}")
        ...
        self.bt_chk_b = QPushButton(self.fKey)
        self.bt_chk_b.setObjectName(u"bt_chk_b")
        sizePolicy2 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.bt_chk_b.sizePolicy().hasHeightForWidth())
        self.bt_chk_b.setSizePolicy(sizePolicy2)
        self.bt_chk_b.setMinimumSize(QSize(65, 41))
        self.bt_chk_b.setMaximumSize(QSize(65, 41))
        self.bt_chk_b.setCursor(QCursor(Qt.CursorShape.WhatsThisCursor))
        self.bt_chk_b.setIconSize(QSize(24, 24))
        self.bt_chk_b.setCheckable(True)
        self.bt_chk_b.setFlat(False)

        self.horizontalLayout_37.addWidget(self.bt_chk_b)

        self.bt_chk_r = QPushButton(self.fKey)
        self.bt_chk_r.setObjectName(u"bt_chk_r")
        sizePolicy2.setHeightForWidth(self.bt_chk_r.sizePolicy().hasHeightForWidth())
        self.bt_chk_r.setSizePolicy(sizePolicy2)
        self.bt_chk_r.setMinimumSize(QSize(65, 41))
        self.bt_chk_r.setMaximumSize(QSize(65, 41))
        self.bt_chk_r.setCursor(QCursor(Qt.CursorShape.WhatsThisCursor))
        self.bt_chk_r.setIconSize(QSize(24, 24))
        self.bt_chk_r.setCheckable(True)
        self.bt_chk_r.setFlat(False)

        self.horizontalLayout_37.addWidget(self.bt_chk_r)

        self.bt_chk_m = QPushButton(self.fKey)
        self.bt_chk_m.setObjectName(u"bt_chk_m")
        sizePolicy2.setHeightForWidth(self.bt_chk_m.sizePolicy().hasHeightForWidth())
        self.bt_chk_m.setSizePolicy(sizePolicy2)
        self.bt_chk_m.setMinimumSize(QSize(65, 41))
        self.bt_chk_m.setMaximumSize(QSize(65, 41))
        self.bt_chk_m.setCursor(QCursor(Qt.CursorShape.WhatsThisCursor))
        self.bt_chk_m.setIconSize(QSize(24, 24))
        self.bt_chk_m.setCheckable(True)
        self.bt_chk_m.setFlat(False)

        self.horizontalLayout_37.addWidget(self.bt_chk_m)

        self.bt_chk_carton1 = QPushButton(self.fKey)
        self.bt_chk_carton1.setObjectName(u"bt_chk_carton1")
        sizePolicy2.setHeightForWidth(self.bt_chk_carton1.sizePolicy().hasHeightForWidth())
        self.bt_chk_carton1.setSizePolicy(sizePolicy2)
        self.bt_chk_carton1.setMinimumSize(QSize(65, 41))
        self.bt_chk_carton1.setMaximumSize(QSize(65, 41))
        self.bt_chk_carton1.setCursor(QCursor(Qt.CursorShape.WhatsThisCursor))
        self.bt_chk_carton1.setIconSize(QSize(24, 24))
        self.bt_chk_carton1.setCheckable(True)
        self.bt_chk_carton1.setFlat(False)

        self.horizontalLayout_37.addWidget(self.bt_chk_carton1)

        self.bt_chk_carton2 = QPushButton(self.fKey)
        self.bt_chk_carton2.setObjectName(u"bt_chk_carton2")
        sizePolicy2.setHeightForWidth(self.bt_chk_carton2.sizePolicy().hasHeightForWidth())
        self.bt_chk_carton2.setSizePolicy(sizePolicy2)
        self.bt_chk_carton2.setMinimumSize(QSize(65, 41))
        self.bt_chk_carton2.setMaximumSize(QSize(65, 41))
        self.bt_chk_carton2.setCursor(QCursor(Qt.CursorShape.WhatsThisCursor))
        self.bt_chk_carton2.setIconSize(QSize(24, 24))
        self.bt_chk_carton2.setCheckable(True)
        self.bt_chk_carton2.setFlat(False)

        self.horizontalLayout_37.addWidget(self.bt_chk_carton2)

        self.bt_chk_ship = QPushButton(self.fKey)
        self.bt_chk_ship.setObjectName(u"bt_chk_ship")
        sizePolicy2.setHeightForWidth(self.bt_chk_ship.sizePolicy().hasHeightForWidth())
        self.bt_chk_ship.setSizePolicy(sizePolicy2)
        self.bt_chk_ship.setMinimumSize(QSize(65, 41))
        self.bt_chk_ship.setMaximumSize(QSize(65, 41))
        self.bt_chk_ship.setCursor(QCursor(Qt.CursorShape.WhatsThisCursor))
        self.bt_chk_ship.setIconSize(QSize(24, 24))
        self.bt_chk_ship.setCheckable(True)
        self.bt_chk_ship.setFlat(False)

        self.horizontalLayout_37.addWidget(self.bt_chk_ship)

        self.bt_chk_wic = QPushButton(self.fKey)
        self.bt_chk_wic.setObjectName(u"bt_chk_wic")
        sizePolicy2.setHeightForWidth(self.bt_chk_wic.sizePolicy().hasHeightForWidth())
        self.bt_chk_wic.setSizePolicy(sizePolicy2)
        self.bt_chk_wic.setMinimumSize(QSize(65, 41))
        self.bt_chk_wic.setMaximumSize(QSize(65, 41))
        self.bt_chk_wic.setCursor(QCursor(Qt.CursorShape.WhatsThisCursor))
        self.bt_chk_wic.setIconSize(QSize(24, 24))
        self.bt_chk_wic.setCheckable(True)
        self.bt_chk_wic.setFlat(False)

        self.horizontalLayout_37.addWidget(self.bt_chk_wic)


        self.gridLayout.addLayout(self.horizontalLayout_37, 0, 1, 1, 1)
        ...
        self.verticalLayout.setContentsMargins(-1, 19, -1, -1)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.tx_view_blabel.sizePolicy().hasHeightForWidth())
        self.tx_view_blabel.setSizePolicy(sizePolicy2)
        self.tx_view_blabel.setMinimumSize(QSize(499, 0))
        self.tx_view_blabel.setMaximumSize(QSize(507, 16777215))
        self.tx_view_blabel.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_blabel.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.tx_view_des.setMaximumSize(QSize(508, 16777215))
        self.tx_view_des.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_des.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.horizontalLayout_6.setContentsMargins(0, 27, 5, -1)
...
"}")
        ...
        self.tx_view_rlabel.setMinimumSize(QSize(256, 0))
        self.tx_view_rlabel.setMaximumSize(QSize(260, 16777215))
        self.tx_view_rlabel.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_rlabel.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        sizePolicy4.setHorizontalStretch(115)
        sizePolicy4.setVerticalStretch(32)
        sizePolicy4.setHeightForWidth(self.tx_view_upc.sizePolicy().hasHeightForWidth())
        self.tx_view_upc.setSizePolicy(sizePolicy4)
...
"    padding: 5px;\n"
"}")
        self.tx_view_upc.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.tx_view_brand.sizePolicy().hasHeightForWidth())
        self.tx_view_brand.setSizePolicy(sizePolicy5)
...
"    padding: 5px;\n"
"}")
        self.tx_view_brand.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        self.tx_view_softVer = QLineEdit(self.fKey)
        self.tx_view_softVer.setObjectName(u"tx_view_softVer")
        sizePolicy6 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        sizePolicy6.setHorizontalStretch(0)
        sizePolicy6.setVerticalStretch(0)
        sizePolicy6.setHeightForWidth(self.tx_view_softVer.sizePolicy().hasHeightForWidth())
        self.tx_view_softVer.setSizePolicy(sizePolicy6)
        self.tx_view_softVer.setMinimumSize(QSize(150, 0))
        self.tx_view_softVer.setMaximumSize(QSize(153, 16777215))
        self.tx_view_softVer.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_softVer.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_34.addWidget(self.tx_view_softVer)
        ...
        self.label_41 = QLabel(self.fKey)
...
"}")
        ...
        self.tx_IMEI_start = QLineEdit(self.fKey)
        self.tx_IMEI_start.setObjectName(u"tx_IMEI_start")
        sizePolicy4.setHeightForWidth(self.tx_IMEI_start.sizePolicy().hasHeightForWidth())
        self.tx_IMEI_start.setSizePolicy(sizePolicy4)
        self.tx_IMEI_start.setMinimumSize(QSize(150, 0))
        self.tx_IMEI_start.setMaximumSize(QSize(150, 32))
        self.tx_IMEI_start.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_IMEI_start.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_35.addWidget(self.tx_IMEI_start)
        ...
        self.label_42 = QLabel(self.fKey)
...
"}")
        ...
        self.tx_view_IMEI_end = QLineEdit(self.fKey)
        self.tx_view_IMEI_end.setObjectName(u"tx_view_IMEI_end")
        sizePolicy5.setHeightForWidth(self.tx_view_IMEI_end.sizePolicy().hasHeightForWidth())
        self.tx_view_IMEI_end.setSizePolicy(sizePolicy5)
        self.tx_view_IMEI_end.setMinimumSize(QSize(65, 0))
        self.tx_view_IMEI_end.setMaximumSize(QSize(150, 32))
        self.tx_view_IMEI_end.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_IMEI_end.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_36.addWidget(self.tx_view_IMEI_end)


        self.horizontalLayout_33.addLayout(self.horizontalLayout_36)


        self.gridLayout.addLayout(self.horizontalLayout_33, 3, 0, 1, 2)
...
"}")
        ...
        self.horizontalLayout_9.setSpacing(74)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.tx_view_sap.sizePolicy().hasHeightForWidth())
        self.tx_view_sap.setSizePolicy(sizePolicy2)
        self.tx_view_sap.setMinimumSize(QSize(200, 0))
        self.tx_view_sap.setMaximumSize(QSize(200, 16777215))
        self.tx_view_sap.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_sap.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.horizontalLayout_8.setContentsMargins(-1, -1, 4, -1)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.tx_view_color.sizePolicy().hasHeightForWidth())
        self.tx_view_color.setSizePolicy(sizePolicy2)
        self.tx_view_color.setMinimumSize(QSize(200, 0))
        self.tx_view_color.setMaximumSize(QSize(200, 16777215))
        self.tx_view_color.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_color.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.tx_view_qr.sizePolicy().hasHeightForWidth())
        self.tx_view_qr.setSizePolicy(sizePolicy2)
        self.tx_view_qr.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_qr.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.tx_view_price.sizePolicy().hasHeightForWidth())
        self.tx_view_price.setSizePolicy(sizePolicy2)
        self.tx_view_price.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_price.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.horizontalLayout_13.setSpacing(23)
        self.horizontalLayout_13.setObjectName(u"horizontalLayout_13")
        self.horizontalLayout_13.setContentsMargins(0, -1, 5, -1)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.tx_view_mlabel.sizePolicy().hasHeightForWidth())
        self.tx_view_mlabel.setSizePolicy(sizePolicy2)
        self.tx_view_mlabel.setMaximumSize(QSize(515, 16777215))
        self.tx_view_mlabel.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_mlabel.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_13.addWidget(self.tx_view_mlabel)


        self.gridLayout.addLayout(self.horizontalLayout_13, 8, 0, 1, 2)
        ...
        sizePolicy7.setHeightForWidth(self.fPrint.sizePolicy().hasHeightForWidth())
        self.fPrint.setSizePolicy(sizePolicy7)
        self.fPrint.setStyleSheet(u"#fPrint\n"
"{\n"
" background-color: #26364d;\n"
"}")
        self.fPrint.setFrameShape(QFrame.Shape.StyledPanel)
        self.fPrint.setFrameShadow(QFrame.Shadow.Raised)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.tx_view_carton.sizePolicy().hasHeightForWidth())
        self.tx_view_carton.setSizePolicy(sizePolicy2)
        self.tx_view_carton.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_carton.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.tx_view_pallet1.sizePolicy().hasHeightForWidth())
        self.tx_view_pallet1.setSizePolicy(sizePolicy2)
        self.tx_view_pallet1.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_pallet1.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.tx_view_pallet2.sizePolicy().hasHeightForWidth())
        self.tx_view_pallet2.setSizePolicy(sizePolicy2)
        self.tx_view_pallet2.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_pallet2.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.tx_view_pallet3.sizePolicy().hasHeightForWidth())
        self.tx_view_pallet3.setSizePolicy(sizePolicy2)
        self.tx_view_pallet3.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_pallet3.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.tx_view_repair.sizePolicy().hasHeightForWidth())
        self.tx_view_repair.setSizePolicy(sizePolicy2)
        self.tx_view_repair.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_repair.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.tx_view_ship.sizePolicy().hasHeightForWidth())
        self.tx_view_ship.setSizePolicy(sizePolicy2)
        self.tx_view_ship.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_ship.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.tx_view_overlay.sizePolicy().hasHeightForWidth())
        self.tx_view_overlay.setSizePolicy(sizePolicy2)
        self.tx_view_overlay.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_overlay.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.tx_view_carton2.sizePolicy().hasHeightForWidth())
        self.tx_view_carton2.setSizePolicy(sizePolicy2)
        self.tx_view_carton2.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_carton2.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.tx_view_wic.sizePolicy().hasHeightForWidth())
        self.tx_view_wic.setSizePolicy(sizePolicy2)
        self.tx_view_wic.setStyleSheet(u"QLineEdit {\n"
"    border: 2px solid gray;\n"
"    border-radius: 5px;\n"
"    padding: 5px;\n"
"}")
        self.tx_view_wic.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        self.f_bulk_find.setFrameShape(QFrame.Shape.StyledPanel)
        self.f_bulk_find.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.lb_bulk_caption.setFont(font1)
...
"}")
        self.f_button.setFrameShape(QFrame.Shape.StyledPanel)
        self.f_button.setFrameShadow(QFrame.Shadow.Raised)
        ...
        sizePolicy3.setHeightForWidth(self.bt_bulk_keyConfig.sizePolicy().hasHeightForWidth())
        self.bt_bulk_keyConfig.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.bt_bulk_single_inspect.sizePolicy().hasHeightForWidth())
        self.bt_bulk_single_inspect.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.bt_bulk_autoLoad_key.sizePolicy().hasHeightForWidth())
        self.bt_bulk_autoLoad_key.setSizePolicy(sizePolicy3)
...
"	background-color:#26364d;\n"
"}")
        self.f_bulk_content.setFrameShape(QFrame.Shape.StyledPanel)
        self.f_bulk_content.setFrameShadow(QFrame.Shadow.Raised)
...
"}")
        self.f_button_print.setFrameShape(QFrame.Shape.StyledPanel)
        self.f_button_print.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.lb_maintain_caption.setFont(font1)
...
"    transform: scale(0.95);       /* (Kh\u00f4ng h\u1ed7 tr\u1ee3"
                        " trong Qt CSS, ch\u1ec9 c\u00f3 th\u1ec3 d\u00f9ng animation) */\n"
"}")
        self.f_single_find.setFrameShape(QFrame.Shape.StyledPanel)
        self.f_single_find.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.tx_maintain_surfix_2.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.tx_maintain_sku_2.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"    transform: scale(0.95);       /* (Kh\u00f4ng h\u1ed7 tr\u1ee3 "
                        "trong Qt CSS, ch\u1ec9 c\u00f3 th\u1ec3 d\u00f9ng animation) */\n"
"}")
        self.f_single_key.setFrameShape(QFrame.Shape.StyledPanel)
        self.f_single_key.setFrameShadow(QFrame.Shadow.Raised)
...
"	text-align: left;\n"
"}")
        self.lb_branch_text_2.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"	color:white;\n"
"}")
        self.lb_branch_text_4.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"    transform: scale(0.95);       /* (Kh\u00f4ng h\u1ed7 tr\u1ee3"
                        " trong Qt CSS, ch\u1ec9 c\u00f3 th\u1ec3 d\u00f9ng animation) */\n"
"}")
        self.f_single_Print.setFrameShape(QFrame.Shape.StyledPanel)
...
"	color:white;\n"
"}")
        self.lb_branch_text_3.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        self.lb_tieuDe_5.setFont(font1)
...
"}")
        self.f_real_find.setFrameShape(QFrame.Shape.StyledPanel)
        self.f_real_find.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.cb_realtime_surfix.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.gridLayout_16.addWidget(self.list_realtime_sku, 6, 0, 1, 1)
...
" background-color: #26364d;\n"
"}")
        self.f_real_content.setFrameShape(QFrame.Shape.StyledPanel)
        self.f_real_content.setFrameShadow(QFrame.Shadow.Raised)
...
"}\n"
"")
        self.frfooter.setFrameShape(QFrame.Shape.StyledPanel)
        self.frfooter.setFrameShadow(QFrame.Shadow.Raised)
        ...
        font3.setBold(True)
        self.lb_notice.setFont(font3)
        self.lb_notice.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.lb_notice.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
"}")
        self.frTab.setFrameShape(QFrame.Shape.StyledPanel)
        self.frTab.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.lb_branch_text.setFont(font4)
        self.lb_branch_text.setStyleSheet(u"QLabel\n"
"{\n"
"	color:white;\n"
"}")
        self.lb_branch_text.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        sizePolicy2.setHeightForWidth(self.bt_view_config.sizePolicy().hasHeightForWidth())
        self.bt_view_config.setSizePolicy(sizePolicy2)
        self.bt_view_config.setMinimumSize(QSize(131, 45))
        self.bt_view_config.setCursor(QCursor(Qt.CursorShape.WhatsThisCursor))
        icon = QIcon()
        ...
        sizePolicy2.setHeightForWidth(self.bt_bulk_import.sizePolicy().hasHeightForWidth())
        self.bt_bulk_import.setSizePolicy(sizePolicy2)
        self.bt_bulk_import.setMinimumSize(QSize(131, 45))
        icon1 = QIcon()
        ...
        sizePolicy2.setHeightForWidth(self.bt_single_maintain.sizePolicy().hasHeightForWidth())
        self.bt_single_maintain.setSizePolicy(sizePolicy2)
        self.bt_single_maintain.setMinimumSize(QSize(131, 45))
        icon2 = QIcon()
        ...
        sizePolicy2.setHeightForWidth(self.bt_realtime_check.sizePolicy().hasHeightForWidth())
        self.bt_realtime_check.setSizePolicy(sizePolicy2)
        self.bt_realtime_check.setMinimumSize(QSize(131, 45))
        icon3 = QIcon()
        ...
        self.bt_chk_modify_date = QPushButton(self.frTab)
        self.bt_chk_modify_date.setObjectName(u"bt_chk_modify_date")
        sizePolicy2.setHeightForWidth(self.bt_chk_modify_date.sizePolicy().hasHeightForWidth())
        self.bt_chk_modify_date.setSizePolicy(sizePolicy2)
        self.bt_chk_modify_date.setMinimumSize(QSize(131, 45))
        icon4 = QIcon()
        icon4.addFile(u":/img/teacherssmall1.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.bt_chk_modify_date.setIcon(icon4)
        self.bt_chk_modify_date.setIconSize(QSize(24, 24))
        self.bt_chk_modify_date.setCheckable(True)

        self.verticalLayout_5.addWidget(self.bt_chk_modify_date)
        ...
        self.mulPage.setCurrentIndex(3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bt_chk_b.setText(QCoreApplication.translate("MainWindow", u"B-Label", None))
        self.bt_chk_r.setText(QCoreApplication.translate("MainWindow", u"R-Label", None))
        self.bt_chk_m.setText(QCoreApplication.translate("MainWindow", u"M-Label", None))
        self.bt_chk_carton1.setText(QCoreApplication.translate("MainWindow", u"Carton1", None))
        self.bt_chk_carton2.setText(QCoreApplication.translate("MainWindow", u"Carton2", None))
        self.bt_chk_ship.setText(QCoreApplication.translate("MainWindow", u"Ship", None))
        self.bt_chk_wic.setText(QCoreApplication.translate("MainWindow", u"Wic", None))
        ...
        self.label_39.setText(QCoreApplication.translate("MainWindow", u"Soft Ver", None))
        self.label_41.setText(QCoreApplication.translate("MainWindow", u"IMEI1", None))
        self.label_42.setText(QCoreApplication.translate("MainWindow", u"IMEI2", None))
        ...
        self.chk_maintain_color.setText(QCoreApplication.translate("MainWindow", u"Carton_Color", None))
        ...
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"List SKU :", None))
        ...
        self.bt_chk_modify_date.setText(QCoreApplication.translate("MainWindow", u"Modify Mapping Date", None))
    # retranslateUi
